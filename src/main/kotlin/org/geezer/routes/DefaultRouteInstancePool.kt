...
class DefaultRouteInstancePool : RouteInstancePool {
    override fun borrowRouteInstance(routeClass: KClass<*>): Any = routeClass.primaryConstructor?.call() ?: throw IllegalArgumentException("Route class ${routeClass.qualifiedName} has no default constructor.")
